 ...
 */
final class Version20221120163134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD projection VARBINARY(255) DEFAULT NULL, DROP accueil_benevole_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE user ADD accueil_benevole_id INT DEFAULT NULL, DROP projection');
